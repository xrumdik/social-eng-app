...
Это репозиторий **с кодом** — Hugo-сайт (6 статей об атаках социальной инженерии), Dockerfile и workflow сборки образа. Манифесты для развёртывания в кластер находятся в **отдельном** архиве/репозитории `k8s-gitops` (см. соответствующий README там).
